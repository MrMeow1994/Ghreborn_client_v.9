final class ProjectTile extends Animable
{
    ...
    {
        Model model = aSpotAnimation_1592.method266();
        if(model == null)
            return null;
        int j = -1;
        if(aSpotAnimation_1592.animationDefinition != null)
            j = aSpotAnimation_1592.animationDefinition.frames[anInt1593];
        Model model_1 = new Model(9, true, FrameLoader.method532(j, false), false, model);
        if(j != -1)
        {
            model_1.createBones();
        ...
        if(aSpotAnimation_1592.anInt410 != 128 || aSpotAnimation_1592.anInt411 != 128)
            model_1.scaleT(aSpotAnimation_1592.anInt410, aSpotAnimation_1592.anInt410, anInt1573, aSpotAnimation_1592.anInt411);
        model_1.method474(anInt1596, 1);
        model_1.method479(64 + aSpotAnimation_1592.anInt413, 850 + aSpotAnimation_1592.anInt414, -30, -50, -30, true);
        if(i != 4016)
    ...
    public ProjectTile(int i, int j, int l, int i1, int j1, int k1,
                       int l1, int i2, int j2, int k2, int l2)
    {
        anInt1573 = 9;
        aBoolean1579 = false;
        aBoolean1591 = true;
        aSpotAnimation_1592 = SpotAnimation.cache[l2];
    ...
    public final void method456(int i, int j)
    {
        ...
        if(aSpotAnimation_1592.animationDefinition != null)
            for(anInt1594 += i; anInt1594 > aSpotAnimation_1592.animationDefinition.method258(anInt1593, (byte)-39);)
            {
                anInt1594 -= aSpotAnimation_1592.animationDefinition.method258(anInt1593, (byte)-39) + 1;
                anInt1593++;
                if(anInt1593 >= aSpotAnimation_1592.animationDefinition.frameCount)
                    anInt1593 = 0;
            }
    ...
    private SpotAnimation aSpotAnimation_1592;
